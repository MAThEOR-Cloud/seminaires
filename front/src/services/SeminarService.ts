...
export default class SeminarService {
	getAll(): Promise<SeminarModel[]> {
		return new Promise<SeminarModel[]>((resolve, reject) => {
	    	...
	    	{ id: 16, title: "Toward an Optimal Consensus Protocol for Private Blockchains", author: "Kenza Riahi", equip: "OMEGA", date: 1656585600, duration: 30, mail: "", abstract: true, slides: false, },
	    	...
	    	{ id: 12, title: "Image Compression by Partial Differential Equations", author: "Thomas Jacumin", equip: "Analyse", date: 1654769400, duration: 30, mail: "thomas.jacumin@uha.fr", abstract: true, slides: false, },
	    	...
	    	{ id: 6, title: "Un pont entre les Mathématiques et la Musique : le Tonnetz", author: "Victoria Callet", equip: "Algèbre (IRMA)", date: 1652350200, duration: 30, mail: "", abstract: false, slides: false, },
