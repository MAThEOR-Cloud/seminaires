...
export default class SeminarService {
	getAll(): Promise<SeminarModel[]> {
		return new Promise<SeminarModel[]>((resolve, reject) => {
	    	...
	    	{ id: 16, title: "Toward an Optimal Consensus Protocol for Private Blockchains", author: "Kenza Riahi", equip: "OMEGA", date: 1656585600, duration: 30, mail: "", },
	    	...
	    	{ id: 2, title: "Network Anomaly Detection in IoT : from Data Efficiency to Enhancing QoS", author: "Mustafa Al Samara", equip: "RT", date: 1649326800, duration: 30, mail: "", }, 
